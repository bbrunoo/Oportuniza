...
namespace Oportuniza.Infrastructure.Migrations
{
    ...
    [Migration("20251102181000_candidateExtras")]
    partial class candidateExtras
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Oportuniza.Domain.Models.CandidateExtra", b =>
                {
                    ...
                    b.Property<Guid?>("CandidateApplicationId1")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CandidateApplicationId1")
                        .IsUnique()
                        .HasFilter("[CandidateApplicationId1] IS NOT NULL");
            ...
            modelBuilder.Entity("Oportuniza.Domain.Models.CompanyRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("25a08e31-50d4-41bc-bb17-dfbfa49b0195"),
                            Name = "Administrator"
                        },
                        new
                        {
                            Id = new Guid("4dada3ed-d4f2-46ac-8b07-5760c546414e"),
                            Name = "Worker"
                        });
                });
            ...
            modelBuilder.Entity("Oportuniza.Domain.Models.CandidateExtra", b =>
                {
                    ...
                    b.HasOne("Oportuniza.Domain.Models.CandidateApplication", null)
                        .WithOne("CandidateExtra")
                        .HasForeignKey("Oportuniza.Domain.Models.CandidateExtra", "CandidateApplicationId1");
